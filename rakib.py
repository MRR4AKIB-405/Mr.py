...
def helpnote():
	...
	subprocess.check_output(["am", "start", " https://www.facebook.com/ltz.ariyan.Sakib/"])
	exit(" [*] FACEBOOK : https://www.facebook.com/ltz.ariyan.Sakib/")
...
def notice():
	...
	runtxt("\033[0;93m ADMIN FACEBOOK >> \033[0;92mMR RAKIB\033[0;92m")
	subprocess.check_output(["am", "start", "https://www.facebook.com/ltz.ariyan.Sakib/"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/MRR4AKIB-405/Aprooval.txt/blob/main/Aprooval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            MR.RAKIB
     \033[1;91m➣ \033[1;92mFACEBOOK   :            MD RAKIB HOSSEN
     \033[1;93m➣ \033[1;92mWHATSAPP   :            01403380158
     \033[1;96m➣ \033[1;92mGITHUB     :            MR.RAKIB-405
